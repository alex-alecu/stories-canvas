## Shared Appearance And Illustration Rules

- The selected illustration style for this story is: "{{style_description}}".
...
- The first page in a location must establish a concrete spatial layout using explicit left, right, center, foreground, and background directions.
