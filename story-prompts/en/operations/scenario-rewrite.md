...
For new generated stories, the valid page count is exactly 10 pages numbered 1 through 10.
Keep original-story casts small. For faithful retellings, keep required canonical roles when prompt fidelity depends on them. Keep scenes vivid, the conflict child-readable, the danger gentle, and the ending comforting.
