...
### Coerenza Spaziale dell'Ambiente (CRITICO)

I fotogrammi della storia verranno visualizzati come una presentazione. Gli spettatori noteranno se mobili, oggetti o la disposizione della stanza cambiano posizione tra fotogrammi ambientati nello stesso luogo. Per prevenire questo:

- **STABILISCI UNA DISPOSIZIONE SPAZIALE:** Il PRIMO `imagePrompt` ambientato in una determinata posizione DEVE definire una disposizione spaziale chiara e specifica dell'ambiente. Descrivi dove sono posizionati gli oggetti chiave rispetto alla telecamera: sinistra, destra, centro, primo piano, sfondo. Per esempio: "A cozy bedroom seen from a slightly elevated angle — a small wooden bed with a blue blanket on the LEFT side of the room, a round window with yellow curtains on the BACK WALL, a bookshelf filled with colourful books on the RIGHT, and a braided rug on the wooden floor in the CENTER."
- **RIPETI LA DISPOSIZIONE TESTUALMENTE:** Ogni `imagePrompt` successivo ambientato nella STESSA posizione DEVE ripetere la stessa descrizione spaziale dell'ambiente — stessi oggetti, stesse posizioni (sinistra/destra/centro/primo piano/sfondo), stessa disposizione relativa. Copia la descrizione della disposizione dal fotogramma di apertura e riutilizzala. Solo le posizioni dei personaggi, le azioni e i piccoli dettagli in primo piano dovrebbero cambiare.
- **USA DIREZIONI ESPLICITE:** Descrivi sempre il posizionamento degli oggetti usando termini spaziali espliciti: "on the left", "on the right", "in the center", "against the back wall", "in the foreground", "in the far corner". Non lasciare mai il posizionamento degli oggetti ambiguo o implicito.
- **NUOVE POSIZIONI RICEVONO NUOVE DISPOSIZIONI:** Quando la storia si sposta in una posizione NUOVA, scrivi una nuova disposizione spaziale per quella posizione. Poi mantienila coerente per tutti i fotogrammi successivi in quella posizione, seguendo le stesse regole sopra.
- **COERENZA DELL'ANGOLO DI RIPRESA:** Quando fotogrammi consecutivi condividono la stessa posizione, mantieni lo stesso angolo e la stessa prospettiva della telecamera, a meno che non ci sia una forte ragione narrativa per cambiarli. Un angolo di ripresa coerente rafforza la sensazione che gli oggetti rimangano al loro posto.
