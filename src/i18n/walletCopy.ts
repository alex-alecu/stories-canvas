...
export function getWalletCopy(language: string) {
  return language === 'ro' ? {
    ...
    openRouterCosts: 'Costuri OpenRouter (USD)', textCost: 'Text', imageCost: 'Imagini', totalCost: 'Total',
    ...
    openRouterCosts: 'OpenRouter costs (USD)', textCost: 'Text', imageCost: 'Images', totalCost: 'Total',
